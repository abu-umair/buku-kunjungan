...
use App\Filament\Resources\Tata_usahaResource\Pages;
use App\Filament\Resources\Tata_usahaResource\RelationManagers;
...
class Tata_usahaResource extends Resource
{
    protected static ?string $model = Tata_usaha::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $navigationLabel = 'Tata Usaha';

    protected static ?string $slug = 'kelola-tata-usaha';


    public static ?string $label = 'Tata Usaha';

    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                // Section::make('Tata Usaha')
                //     // ->description('Tata_usaha')
                //     ->schema([
                Select::make('tamu_id')
                    ->label('Pilih Tamu')
    ...
    {
        return [
            'index' => Pages\ListTata_usahas::route('/'),
            'create' => Pages\CreateTata_usaha::route('/create'),
            'edit' => Pages\EditTata_usaha::route('/{record}/edit'),
        ];
    }
}
